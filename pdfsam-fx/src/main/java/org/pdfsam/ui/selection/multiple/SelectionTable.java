...
public class SelectionTable extends TableView<SelectionTableRowData> implements ModuleOwned, RestorableView {
	private SelectionTableProduct selectionTableProduct = new SelectionTableProduct();
    ...
    public SelectionTable(String ownerModule, boolean canDuplicateItems, boolean canMove,
        ...
        selectionTableProduct.initTopSectionContextMenu(contextMenu, Arrays.stream(columns).anyMatch(PageRangesColumn.class::isInstance),ownerModule);
        selectionTableProduct.initItemsSectionContextMenu(contextMenu, canDuplicateItems, canMove, ownerModule);
        selectionTableProduct.initBottomSectionContextMenu(contextMenu);
